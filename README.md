...
1. Download `Weave-Loader-Agent-0.2.6.jar` (or whatever the latest version is called) from [Weave Loader Agent Releases](https://github.com/Weave-MC/Weave-Loader/releases).
